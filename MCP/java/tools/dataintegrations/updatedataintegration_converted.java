...
class Patch_Data_Integrations_IdentifierMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPatch_Data_Integrations_IdentifierHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("Name")) {
            queryParams.add("Name=" + args.get("Name"));
                ...
                String url = config.getBaseUrl() + "/api/v2/patch_data_integrations_identifier" + queryString;
    ...
    public static MCPServer.Tool createPatch_Data_Integrations_IdentifierTool(MCPServer.APIConfig config) {
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "patch_data_integrations_identifier",
            "No description available",
            parameters
        );
        
        return new MCPServer.Tool(definition, getPatch_Data_Integrations_IdentifierHandler(config));
    }
