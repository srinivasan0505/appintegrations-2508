...
func DeleteeventintegrationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.DeleteEventIntegrationResponse
...
func CreateDeleteeventintegrationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_eventIntegrations_Name",
		mcp.WithDescription("Deletes the specified existing event integration. If the event integration is associated with clients, the request is rejected."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeleteeventintegrationHandler(cfg),
	}
}
