...
func ListeventintegrationsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/eventIntegrations%s", cfg.BaseURL, queryString)
		...
		var result models.ListEventIntegrationsResponse
...
func CreateListeventintegrationsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_eventIntegrations",
		mcp.WithDescription("Returns a paginated list of event integrations in the account."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListeventintegrationsHandler(cfg),
	}
}
