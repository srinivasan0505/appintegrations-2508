...
func UpdateeventintegrationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.UpdateEventIntegrationrequest
		...
		url := fmt.Sprintf("%s/eventIntegrations/%s", cfg.BaseURL, Name)
		...
		var result models.UpdateEventIntegrationResponse
...
func CreateUpdateeventintegrationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_eventIntegrations_Name",
		mcp.WithDescription("Updates the description of an event integration."),
		...
		mcp.WithString("Description", mcp.Description("Input parameter: The description of the event inegration.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    UpdateeventintegrationHandler(cfg),
	}
}
