...
func CreateeventintegrationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.CreateEventIntegrationrequest
		...
		url := fmt.Sprintf("%s/eventIntegrations", cfg.BaseURL)
		...
		var result models.CreateEventIntegrationResponse
...
func CreateCreateeventintegrationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_eventIntegrations",
		...
		mcp.WithString("Description", mcp.Description("Input parameter: The description of the event integration.")),
		mcp.WithString("EventBridgeBus", mcp.Required(), mcp.Description("Input parameter: The EventBridge bus.")),
		mcp.WithObject("EventFilter", mcp.Required(), mcp.Description("Input parameter: The event filter.")),
		mcp.WithString("Name", mcp.Required(), mcp.Description("Input parameter: The name of the event integration.")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreateeventintegrationHandler(cfg),
	}
}
