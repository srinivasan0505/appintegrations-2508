...
func GeteventintegrationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetEventIntegrationResponse
...
func CreateGeteventintegrationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_eventIntegrations_Name",
		mcp.WithDescription("Returns information about the event integration."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GeteventintegrationHandler(cfg),
	}
}
