...
func ListdataintegrationsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/dataIntegrations%s", cfg.BaseURL, queryString)
		...
		var result models.ListDataIntegrationsResponse
...
func CreateListdataintegrationsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_dataIntegrations",
		mcp.WithDescription("<p>Returns a paginated list of DataIntegrations in the account.</p> <note> <p>You cannot create a DataIntegration association for a DataIntegration that has been previously associated. Use a different DataIntegration, or recreate the DataIntegration using the <a href="https://docs.aws.amazon.com/appintegrations/latest/APIReference/API_CreateDataIntegration.html">CreateDataIntegration</a> API.</p> </note>"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListdataintegrationsHandler(cfg),
	}
}
