...
func DeletedataintegrationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.DeleteDataIntegrationResponse
...
func CreateDeletedataintegrationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_dataIntegrations_Identifier",
		...
		mcp.WithString("Identifier", mcp.Required(), mcp.Description("A unique identifier for the DataIntegration.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    DeletedataintegrationHandler(cfg),
	}
}
