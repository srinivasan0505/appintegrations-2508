...
func UpdatedataintegrationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.UpdateDataIntegrationrequest
		...
		var result models.UpdateDataIntegrationResponse
...
func CreateUpdatedataintegrationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_dataIntegrations_Identifier",
		mcp.WithDescription("<p>Updates the description of a DataIntegration.</p> <note> <p>You cannot create a DataIntegration association for a DataIntegration that has been previously associated. Use a different DataIntegration, or recreate the DataIntegration using the <a href="https://docs.aws.amazon.com/appintegrations/latest/APIReference/API_CreateDataIntegration.html">CreateDataIntegration</a> API.</p> </note>"),
		...
		mcp.WithString("Name", mcp.Description("Input parameter: The name of the DataIntegration.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    UpdatedataintegrationHandler(cfg),
	}
}
