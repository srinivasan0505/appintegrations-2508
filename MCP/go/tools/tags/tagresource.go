...
func CreateTagresourceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_tags_resourceArn",
		mcp.WithDescription("Adds the specified tags to the specified resource."),
		...
		mcp.WithObject("tags", mcp.Required(), mcp.Description("Input parameter: The tags used to organize, track, or control access for this resource. For example, { \"tags\": {\"key1\":\"value1\", \"key2\":\"value2\"} }.")),
	)
